...
class RazerMouseDockPro(_RazerDeviceBrightnessSuspend):
    ...
    WAVE_DIRS = (1, 2)
    MATRIX_DIMS = [1, 8]
    METHODS = ['get_device_type_accessory', 'set_brightness', 'get_brightness', 'set_custom_effect',
               'set_key_row', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_none_effect',
